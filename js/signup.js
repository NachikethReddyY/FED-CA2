document.addEventListener('DOMContentLoaded', function() {
    ...
    function showTypeToast() {
        ...
        showToast({
            ...
            body: "Type by yourself, don’t get help!<br><b>— Nachiketh</b>",
            time: 'just now',
            img: 'assets/me.png'
        });
    }
    ...
    // Disallow copy/paste/cut for Goals and Motivation textarea, show toast
    goalsMotivationTextarea.addEventListener('cut', function(e) {
        e.preventDefault();
        showTypeToast();
    });
    goalsMotivationTextarea.addEventListener('paste', function(e) {
        e.preventDefault();
        showTypeToast();
    });
    goalsMotivationTextarea.addEventListener('copy', function(e) {
        e.preventDefault();
        showTypeToast();
    });
